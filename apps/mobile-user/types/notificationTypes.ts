...
export enum NotificationType {
  ...
  WAITLIST_PROMOTE = 'WAITLIST_PROMOTE', // IMPROVEMENT: Waitlist promotion notification
  ...
  BOOKING_REMINDER = 'BOOKING_REMINDER', // IMPROVEMENT: Booking reminder notification
  AUTO_CANCEL_WARNING = 'AUTO_CANCEL_WARNING', // IMPROVEMENT: Auto-cancel warning
  CHECKOUT_REMINDER = 'CHECKOUT_REMINDER', // IMPROVEMENT: Checkout reminder
  ...
  EQUIPMENT_AUTO_STOP_WARNING = 'EQUIPMENT_AUTO_STOP_WARNING', // IMPROVEMENT: Equipment auto-stop warning
