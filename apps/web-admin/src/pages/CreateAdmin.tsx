    ...
    <div className='min-h-screen bg-gray-50'>
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='text-center mb-8'>
          ...
          <h1 className='text-3xl font-bold text-gray-900 mb-2'>Tạo Admin Mới</h1>
          <p className='text-gray-600'>Tạo tài khoản quản trị viên mới cho hệ thống</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className='space-y-3'>
              ...
              <div>
                ...
                <input
                  ...
                  } text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent`}
