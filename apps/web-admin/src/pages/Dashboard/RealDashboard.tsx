    ...
    <div className='min-h-screen bg-gray-50'>
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-gray-600'>Tổng quan hệ thống Gym 147</p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          ...
          <div className='bg-white rounded-lg shadow-sm p-6 border'>
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                <p className='text-sm font-medium text-gray-600'>Lịch tập hôm nay</p>
          ...
          <div className='bg-white rounded-lg shadow-sm p-6 border'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center justify-between py-2 border-b border-gray-100'>
                <div>
                  <p className='text-sm font-medium text-gray-900'>Nguyễn Văn A đăng ký gói tập</p>
              ...
              <div className='flex items-center justify-between py-2 border-b border-gray-100'>
                <div>
                  <p className='text-sm font-medium text-gray-900'>Trần Thị B thanh toán</p>
              ...
              <div className='flex items-center justify-between py-2'>
                <div>
                  <p className='text-sm font-medium text-gray-900'>Lê Văn C đặt lịch tập</p>
