...
const AdminButton: React.FC<AdminButtonProps> = ({
  ...
  return (
    <button
      className={`inline-flex items-center justify-center gap-2 rounded-none font-medium font-heading transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${variantClasses[variant]} ${sizeClasses[size]} ${className}`}
