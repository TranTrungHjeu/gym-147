...
export default function SignUpForm({
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      showToast(error.message || 'Không thể đăng ký với Google', 'error');
    } finally {
            ...
            <>
                ...
                {false && (
                  <div className='mt-2 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg'>
                    <p className='text-xs text-red-600 dark:text-red-400 text-center font-medium'>
                      [WARNING] {signupType === 'email' ? 'Email' : 'Số điện thoại'} này đã được sử
                      dụng!
                    </p>
              ...
              <div className='mt-6'>
                <button
                  type='button'
                  onClick={handleNext}
                  disabled={!validateStep1() || isOAuthLoading}
              ...
              <div className='mt-2'>
                ...
                >
                  ...
                  {isOAuthLoading ? 'Đang xử lý...' : 'ĐĂNG KÝ VỚI GOOGLE'}
                </button>
              </div>
            </>
          )}
