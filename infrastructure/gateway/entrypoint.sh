...
echo "Service URLs configuration:"
echo "  IDENTITY_SERVICE_FULL: ${IDENTITY_SERVICE_FULL}"
echo "  MEMBER_SERVICE_FULL: ${MEMBER_SERVICE_FULL}"
echo "  SCHEDULE_SERVICE_FULL: ${SCHEDULE_SERVICE_FULL}"
echo "  BILLING_SERVICE_FULL: ${BILLING_SERVICE_FULL}"
