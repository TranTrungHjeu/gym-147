-- CreateEnum
CREATE TYPE "InstructorStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'ON_LEAVE', 'TERMINATED');
...
-- CreateEnum
CREATE TYPE "SensorType" AS ENUM ('TEMPERATURE', 'HUMIDITY', 'AIR_QUALITY', 'NOISE_LEVEL', 'OCCUPANCY', 'LIGHT_LEVEL');

-- CreateEnum
CREATE TYPE "SensorStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'MAINTENANCE', 'ERROR');
...
-- CreateEnum
CREATE TYPE "AttendanceMethod" AS ENUM ('MANUAL', 'RFID', 'QR_CODE', 'FACE_RECOGNITION', 'MOBILE_APP');

-- CreateEnum
CREATE TYPE "FeedbackCategory" AS ENUM ('INSTRUCTION_QUALITY', 'CLASS_CONTENT', 'COMMUNICATION', 'PUNCTUALITY', 'PROFESSIONALISM', 'MOTIVATION', 'OVERALL');
...
-- CreateIndex
CREATE UNIQUE INDEX "class_instructors_class_id_instructor_id_role_key" ON "class_instructors"("class_id", "instructor_id", "role");

-- CreateIndex
CREATE UNIQUE INDEX "rooms_name_key" ON "rooms"("name");

-- CreateIndex
CREATE UNIQUE INDEX "rooms_temperature_sensor_id_key" ON "rooms"("temperature_sensor_id");

-- CreateIndex
CREATE UNIQUE INDEX "rooms_humidity_sensor_id_key" ON "rooms"("humidity_sensor_id");

-- CreateIndex
CREATE UNIQUE INDEX "rooms_air_quality_sensor_id_key" ON "rooms"("air_quality_sensor_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "payments_ref_booking_id_key" ON "payments_ref"("booking_id");

-- AddForeignKey
ALTER TABLE "certifications" ADD CONSTRAINT "certifications_instructor_id_fkey" FOREIGN KEY ("instructor_id") REFERENCES "instructors"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "class_instructors" ADD CONSTRAINT "class_instructors_class_id_fkey" FOREIGN KEY ("class_id") REFERENCES "gym_classes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "class_instructors" ADD CONSTRAINT "class_instructors_instructor_id_fkey" FOREIGN KEY ("instructor_id") REFERENCES "instructors"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "room_sensors" ADD CONSTRAINT "room_sensors_room_id_fkey" FOREIGN KEY ("room_id") REFERENCES "rooms"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_class_id_fkey" FOREIGN KEY ("class_id") REFERENCES "gym_classes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "attendance" ADD CONSTRAINT "attendance_schedule_id_fkey" FOREIGN KEY ("schedule_id") REFERENCES "schedules"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "instructor_feedback" ADD CONSTRAINT "instructor_feedback_instructor_id_fkey" FOREIGN KEY ("instructor_id") REFERENCES "instructors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payments_ref" ADD CONSTRAINT "payments_ref_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "bookings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
